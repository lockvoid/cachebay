...
export type relayWriteQueryDefRelayWriteQuery$variables = {
  after?: string | null | undefined;
  first: number;
};
export type relayWriteQueryDefRelayWriteQuery$data = {
  readonly users: {
...
export type relayWriteQueryDefRelayWriteQuery = {
  response: relayWriteQueryDefRelayWriteQuery$data;
  variables: relayWriteQueryDefRelayWriteQuery$variables;
};
...
(node as any).hash = "64b929857c9f43c1be76ab1674178e4e";
